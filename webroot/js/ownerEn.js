...
$('#commentsButtonEn').click(function(){
    $('#comments').show();
    $('#aboutPerson').hide();
    $('#commentsButtonEn').css('border-bottom', '03px #ffad33 solid');
    $('#aboutPersonButtonEn').css('border-bottom', '03px #fff solid');
    $('#commentsButtonEn').find('h5').addClass('text-warning');
    $('#aboutPersonButtonEn').find('h5').removeClass('text-warning');
});

$('#aboutPersonButtonEn').click(function(){
    $('#aboutPerson').show();
    $('#comments').hide();
    $('#aboutPersonButtonEn').css('border-bottom', '03px #ffad33 solid');
    $('#commentsButtonEn').css('border-bottom', '03px #fff solid');
    $('#aboutPersonButtonEn').find('h5').addClass('text-warning');
    $('#commentsButtonEn').find('h5').removeClass('text-warning');
});
...
function ownerInfo (ownerObj) {
    ...
    if (ownerObj[0].rates.length == 0){
        ...
        var numberOfStars = ownerObj[0].rates[0].stars / ownerObj[0].rates[0].count;
        if(numberOfStars>0 && numberOfStars<=1){
            $('#userRatingArea').html('<img src="'+URL+'images/emptyRating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/emptyRating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/emptyRating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/emptyRating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/rating.png" alt="rating" class="userRating2">');
        } if(numberOfStars>1 && numberOfStars<=2){
            $('#userRatingArea').html('<img src="'+URL+'images/emptyRating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/emptyRating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/emptyRating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/rating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/rating.png" alt="rating" class="userRating2">');
        } if(numberOfStars>2 && numberOfStars<=3){
            $('#userRatingArea').html('<img src="'+URL+'images/emptyRating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/emptyRating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/rating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/rating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/rating.png" alt="rating" class="userRating2">');
        } if(numberOfStars>3 && numberOfStars<=4){
            $('#userRatingArea').html('<img src="'+URL+'images/emptyRating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/rating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/rating.png" alt="rating" class="userRating2">'
                +'<img src="'+URL+'images/rating.png" alt="rating" class="userRating2">'
    ...
    $('#aboutPerson').html('<div class="col-12 text-center my-3"><p class="my-3 py-3">'+ownerObj[0].description+'</p></div>');

    // machine photos in carousel
    if(ownerObj[0].machine_owners.length == 0){
        $('.carousel').parent().addClass("text-center py-5").html('<img src="'+URL+'images/no_photos_available.jpg" alt="machine photo" class="img-fluid text-center"><h2 class="order_text text-danger py-2">There is no machine photos for this owner right nowً</h2>');
    }
    else if(ownerObj[0].machine_owners[0].machine_photos.length == 0){
        $('.carousel').parent().addClass("text-center py-5").html('<img src="'+URL+'images/no_photos_available.jpg" alt="machine photo" class="img-fluid text-center"><h2 class="order_text text-danger py-2">There is no machine photos for this owner right now</h2>');
    }else {
...
function viewComments(commentObj){
    if(commentObj.length == 0){
        $('#comments').html('<div class="col-12 text-center py-5"><h5 class="order_text">no comments yet</h5></div>');}
    else {
        for(var m = 0 ; m < commentObj.length ; m++){
            $('#comments').append('<div class="col-2 my-auto mx-0 px-0" id="col-' + m+1 + '"></div>'
                +'<div class="col-6 col-md-7 text-left mx-0 px-0" id="col-' + m+2 + '"></div>'
                +'<div class="col-4 col-md-3 text-left m-0 p-0" id="col-' + m+3 + '"></div>');
            $('#col-' + m+3).html('<h5 class="user_comment_time">'
            ...
            $('#col-' + m+1).html('<div class="ownerImgContainer text-center"><img src="'+URL+'images/customer.png"  class="ownerImage comment_profile_image" alt="profile image"></div>');
        }
    }
}
