...
$(document).attr("title", "Choose Your Machine");
...
$.ajax({
    ...
    success: function (result) {
        ...
        $('.next').on('click', function () {
            ...
            $(this).hide();
            alert(localStorage.getItem('machineId'))
        ...
        $('#reserve').on('click', function (e) {
            ...
            if (empty.length) {
                $('.form').prepend(
                    "<div class='alert alert-danger'>Complete Required Data</div>"
                );
                setTimeout(function () {
                    $('.alert').fadeOut(500);
                }, 3000);
