...
<div class="userContacts form">
    ...
    <fieldset>
        <legend><?= ___('edit user contact') ?></legend>
        
        <div class="panel panel-default">
            <div class="panel-heading">
            <?php
            echo $this->Navbars->actionButtons(['buttons_group' => 'edit', 'model_id' => $userContact->id]);
            ?>
            </div>
            <div class="panel-body">
            
            <?php
            echo $this->AlaxosForm->create($userContact, ['class' => 'form-horizontal', 'role' => 'form', 'novalidate' => 'novalidate']);
            ...
            echo '<div class="form-group">';
            echo $this->AlaxosForm->label('requirement', __('requirement'), ['class' => 'col-sm-2 control-label']);
            echo '<div class="col-sm-5">';
            echo $this->AlaxosForm->input('requirement', ['label' => false, 'class' => 'form-control']);
            echo '</div>';
            echo '</div>';
            
            echo '<div class="form-group">';
            echo $this->AlaxosForm->label('reply_message', __('reply_message'), ['class' => 'col-sm-2 control-label']);
            echo '<div class="col-sm-5">';
            echo $this->AlaxosForm->input('reply_message', ['label' => false, 'class' => 'form-control']);
            echo '</div>';
            echo '</div>';
