<div class="settings index">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<tr class="sortHeader">
				<th></th>
				<th><?php echo $this->Paginator->sort('resvertion_status', ___('resvertion_status')); ?></th>
			...
			<tr class="filterHeader">
				...
				<td>
					<?php
					echo $this->AlaxosForm->filterField('resvertion_status');
					?>
				</td>
				<td>
					<?php
			...
			<?php foreach ($settings as $i => $setting): ?>
				<tr>
					...
					<td>
						<?php echo h($setting->resvertion_status) ?>
					</td>
					<td>
						<?php echo h($setting->to_display_timezone('created')); ?>
					</td>
					<td>
						<?php echo h($setting->to_display_timezone('modified')); ?>
					</td>
					<td class="actions">
						<?php 
