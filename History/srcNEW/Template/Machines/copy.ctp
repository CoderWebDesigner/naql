...
<div class="machines form">
    ...
    <fieldset>
        <legend><?= ___('copy machine') ?></legend>
        
        <div class="panel panel-default">
            <div class="panel-heading">
            <?php
            echo $this->Navbars->actionButtons(['buttons_group' => 'edit', 'model_id' => $machine->id]);
            ?>
            </div>
            <div class="panel-body">
            
            <?php
            echo $this->AlaxosForm->create($machine, ['class' => 'form-horizontal', 'role' => 'form', 'novalidate' => 'novalidate']);
