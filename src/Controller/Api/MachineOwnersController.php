...
class MachineOwnersController extends AppController
{
    ...
    public function initialize()
    {
        ...
        $this->loadComponent('RequestHandler');
          $this->loadComponent('Paginator');
                  $this->Auth->allow(['index','add','edit','view','machineProfile','addIos','multiapleMachinePhotosIos','delete']);
   ...
   ///////// end chek extenstion 
        ...
        $this->set(compact('dataa','machineOwner', 'machineDetails', 'owners','machines','machinePhotos','success','chkOwner','newOwner','chkAddNewMachine'));
        $this->set('_serialize', ['dataa','success','machineOwner','chkAddNewMachine']);
    }
//////////////////////////////////////////////////////////////////
    ...
    function addNewOwner($userId){
           ...
           public function multiapleMachinePhotosIos($machineOwnerId) {
    
    
          $i = 0 ; 
      foreach($this->request->data as $key => $dataa){
      
      $ddd[] = $dataa;
      if(isset($dataa['tmp_name'])) {
            $machinePhotos = $this->MachineOwners->MachinePhotos->newEntity();
                $path_info = pathinfo($dataa['name']);
                chmod($dataa['tmp_name'], 0644);
...
///////// chek extenstion 
                ...
                if (in_array($ext, $supported_image)) {
                    ...
                    move_uploaded_file($dataa['tmp_name'], $fullpath . DS . $photooImg);
...
return $ddd; 
     ...
     public function addIos($userId = null)
    {
    ...
    //   $this->multiapleMachinePhotos($machineOwnerId) ; 
       ...
       $success['photos'] =  $this->multiapleMachinePhotosIos($machineOwnerId);
       if($success['photos'] == null){$success['photos'] = false ;} //multiphotos resposne
   ///////// end chek extenstion 
