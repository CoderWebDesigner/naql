...
<div class="machineDetails form">
    ...
    <fieldset>
        <legend><?= ___('copy machine detail') ?></legend>
        
        <div class="panel panel-default">
            <div class="panel-heading">
            <?php
            echo $this->Navbars->actionButtons(['buttons_group' => 'edit', 'model_id' => $machineDetail->id]);
            ?>
            </div>
            <div class="panel-body">
            
            <?php
            echo $this->AlaxosForm->create($machineDetail, ['class' => 'form-horizontal', 'role' => 'form', 'novalidate' => 'novalidate']);
