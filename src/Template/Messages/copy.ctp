...
<div class="messages form">
    ...
    <fieldset>
        <legend><?= ___('copy message') ?></legend>
        
        <div class="panel panel-default">
            <div class="panel-heading">
            <?php
            echo $this->Navbars->actionButtons(['buttons_group' => 'edit', 'model_id' => $message->id]);
            ?>
            </div>
            <div class="panel-body">
            
            <?php
            echo $this->AlaxosForm->create($message, ['class' => 'form-horizontal', 'role' => 'form', 'novalidate' => 'novalidate']);
