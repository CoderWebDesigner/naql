                    ...
                    <div class="form-horizontal" id="ownerFrm">
                        ...
                        <div class="form-group" style="background: transparent">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button class="btn btn-default regist-owner center-block col-xs-8 col-sm-push-1 col-xs-push-2">Regist</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!--  Custom Script -->
    <script src="<?=URL?>js/updated/ownerRegisterEn.js"></script>
