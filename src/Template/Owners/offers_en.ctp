...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-12 bg-yellow my-auto">
            <img src="<?=URL?>images/back4.png" alt="back button" class="p-0 m-0 float-left my-2 my-sm-3" id="backButton">
            <h6 class="text-center text-dark offers_page_title">Offers For Your Order</h6>
        </div>
    </div>
    <div class="row">
        <div class="col-12 text-center bg-lighter" id="showOffers"></div>
    </div>
</div>
...
<script src="<?=URL?>js/offersEn.js" type="text/javascript"></script>
