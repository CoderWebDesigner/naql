            ...
            <div class="row">
                <div class="form-horizontal form">
                    ...
                    <div class="form-group">
                        ...
                        <div class=" col-sm-10 col-xs-9">
                            <label style="cursor: pointer;margin-top: 16px;">Machines Photo</label>
                    ...
                    <button class="btn btn-default center-block custom-btn" id="reserve">
                        <a href="#myEquips" aria-controls="myEquips" role="tab" data-toggle="tab" id="myMachinesBtn">Add</a>
                    </button>
                </div>
            </div>
        </div>
...
<!--  Custom Script -->
<script src="<?=URL?>js/updated/getMachineTypeEN.js"></script>
