...
?>
  <div class="order-now">
    <div class="container">
      <div class="row">
        <h1 class="text-center" style="font-family: 'arial'">250 معدة في خدمتك</h1>
      </div>
    </div>
  </div>
...
<main>
          ...
          <div class="col-xs-4">
            <div class="step active-step">
              ...
              <div class="step-title hidden-xs">
                <h3 class="text-center "> أختار المعدة</h3>
              </div>
            </div>
          </div>
          <div class="col-xs-4">
            <div class="step">
              ...
              <div class="step-title hidden-xs">
                <h3 class="text-center "> تفاصيل المعدة</h3>
              </div>
            </div>
          </div>
          <div class="col-xs-4">
    ...
    <div class="reservation">
      <div class="container">
        ...
        <button class="btn center-block custom-btn more custom-btn"> التالي
              ...
              <div class="form-horizontal form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10 col-xs-9">
                    <input type='text' class='form-control' id='select-start-area' placeholder='أختر منطقة البداية'>
                      ...
                      <div class='modal-dialog' role='document'>
                        <div class='modal-content'>
                          <div class='modal-header'>
                            ...
                            <h4 class='modal-title' id='myModalLabel'>اختر العنوان</h4>
                          </div>
                ...
                <div class='form-group' id="end-location">
                  ...
                  <div class='col-md-10 col-xs-9'>
                    <input type='text' class='form-control' id='select-end-area' name='endarea' placeholder='أختر منطقة النهاية'>
                ...
                <div class="form-group">
                  ...
                  <div class=" col-sm-10 col-xs-9">
                    <input type="text" class="form-control" id="datepicker1" placeholder="تاريخ/الوقت">
                  </div>
                </div>
                <div class="form-group">
                  <div class="form-icon col-md-2 col-xs-3">
                  ...
                  <div class="form-element col-md-10 col-xs-9">
                    <select class="form-control" id="selectDeal" required>
                      <option selected disabled>مدة التعاقد</option>
                    </select>
                  </div>
                </div>
                ...
                <button class="btn btn-default center-block custom-btn" id="reserve">حجز</button>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="panel-body">
              <div class="complete-msg">
                ...
                <div class="complete-title text-center">
                  <h4>تم إتمام الحجز بنجاح</h4>
                  <p> يرجي انتظار العروض من السائقين</p>

                  <button class="btn btn-default SwtichToOrders">الانتقال الي طلباتي</button>
                </div>
              </div>
            </div>
          </div>
...
var currentLocation;
 ...
 $(".SwtichToOrders").on('click', function () {
