...
<!--	<script src="<?= URL ?>dashboard/js/jquery-3.2.0.min.js"></script>-->
  ...
  <link rel="stylesheet" href="<?= URL ?>dashboard/css/morris.css">
        ...
        <link rel="stylesheet" href="<?=URL?>dashboard/css/status_switch_button.css" type="text/css" />
        <script src="<?=URL?>dashboard/js/status_switch_button.js" type="text/javascript"></script>
...
<!--                                     <ul class="togole">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="listyle" style="    margin-top: 5px;">
                                      ...
                                      <span class=" col-sm-9-5"> عرض الأقسام</span>
                                       ...
                                       <li class="has_sub">
                                <a href="<?=URL?>reservations/reports" class="waves-effect "> <span>تقارير الطلبات</span> <span class="menu-arrow"></span></a>
  ...
  <!----------disaply on in menu off --------->         
                              ...
                              <!-----------------------blacklist----------->
                               ...
                               <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"> <span>حظر شخص</span> <span class="menu-arrow"></span></a>
                                ...
                                <ul class="list-unstyled">
                                      ...
                                      <li class="listyle" style="    margin-top: 5px;">
                                           <a href="<?=URL?>users/addBlackList" class=" col-sm-12">
                                        <img src="<?= URL ?>images/view-list-button.png"  class="icon col-sm-2-5">
                                     <span class="col-sm-9-5"> إضافة حظر لشخص</span>
                                      </a>
                                      </li>
                                    
                                      <li class="listyle" style="    margin-top: 5px;">
                                           <a href="<?=URL?>users/allBlackList" class=" col-sm-12">
                                        <img src="<?= URL ?>images/view-list-button.png"  class="icon col-sm-2-5">
                                     <span class="col-sm-9-5"> قائمة المحظورين</span>
                                      </a>
                                      </li>
  ...
  <!----------disaply on in menu off --------->         
         <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"> <span>طلباتى</span> <span class="menu-arrow"></span></a>
                                ...
                                <ul class="list-unstyled">
                                      ...
                                      <li class="listyle" style="    margin-top: 5px;">
                                           <a href="<?=URL?>reservations/myorders/1" class=" col-sm-12">
                                        <img src="<?= URL ?>images/view-list-button.png"  class="icon col-sm-2-5">
                                     <span class="col-sm-9-5"> طلباتى</span>
                                      </a>
                                      </li>
    ...
    <div class="row">
        <div class="col-12">
            <!-- Rounded switch -->
            <label class="switch">
                <input type="checkbox" id="status_switch_button" onclick="change_status()">
                <span class="slider round"></span>
            </label>
            <p id="current_or_previous">الحالة الحالية :</p>
        </div>
    </div>
  </div>
  <b><p id="new_status">Admin</p></b>              </div>
            </div>    
            <!-- Left Sidebar End -->
