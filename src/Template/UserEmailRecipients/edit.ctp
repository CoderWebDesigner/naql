...
<div class="userEmailRecipients form">
    
    <fieldset>
        <legend><?= ___('edit user email recipient') ?></legend>
        
        <div class="panel panel-default">
            <div class="panel-heading">
            <?php
            echo $this->Navbars->actionButtons(['buttons_group' => 'edit', 'model_id' => $userEmailRecipient->id]);
            ?>
            </div>
            <div class="panel-body">
            
            <?php
            echo $this->AlaxosForm->create($userEmailRecipient, ['class' => 'form-horizontal', 'role' => 'form', 'novalidate' => 'novalidate']);
            
            echo '<div class="form-group">';
            echo $this->AlaxosForm->label('user_email_id', __('user_email_id'), ['class' => 'col-sm-2 control-label']);
            echo '<div class="col-sm-5">';
            echo $this->AlaxosForm->input('user_email_id', ['options' => $userEmails, 'label' => false, 'class' => 'form-control']);
            echo '</div>';
            echo '</div>';
