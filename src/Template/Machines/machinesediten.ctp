                        ...
                        <div class="form-horizontal form">
                            ...
                            <div class="form-group">
                                ...
                                <div class=" col-sm-10 col-xs-9">
                                    <input type="number" class="form-control" placeholder="Machine Count" id="ownerCars">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-icon col-sm-2 col-xs-3">
                            ...
                            <button class="btn btn-default custom-btn" id="updateMachine">
                                Edit
                            </button>
                            <button class="btn btn-default back" style="float:right">
                                back
                            </button>
                        </div>
                    </div>
                ...
                $.each(data, function (k, area) {
                    for (k in area) {
                        editedArea.innerHTML +=
                            "<option value='" + area[k].name_en + "' id='" + area[k].id +
                            "'>" + area[k].name_en + "</option>";
                    }
                })
            }
        });
    ...
    var imagesPreview = function(input, placeToInsertImagePreview) {
      ...
      $('#ownerSelectImgs').on('change', function() {
        ...
        $('.back').on('click', function (e) {
            e.preventDefault();
            window.open("<?=URL?>Owners/onwerprofileen", "_self");
        });
    });
</script>
