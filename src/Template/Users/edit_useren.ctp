                ...
                <!------   ------>
                        ...
                        <div class="form-horizontal" id="ownerFrm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-11 col-xs-10">
                                    <input type="text" class="form-control" id="ownerPassword">
                                </div>
                            </div>
                            <div class="form-group" style="background: transparent">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button class="btn btn-default regist-owner center-block col-xs-8 col-sm-push-1 col-xs-push-2 update">Send</button>
                                </div>
                            </div>
                        </div>
    <script>
